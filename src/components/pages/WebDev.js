...
const WebDev = () =>
  ...
  <div>
    <div>
      <h2 className="portH2">Web App Portfolio Samples:</h2>
    </div>
    <Carousel options={{ fullWidth: true, indicators:true}}>
        ...
        <Col s={12} l={3} className='projDescription'>
          ...
          <a href="https://github.com/smugclimber/SushiCrusher"><button className='btn blue darken-4 waves-effect white teal-text'>Github Repo</button></a>
          <br/><br/>
          <a href="https://pacific-ravine-93168.herokuapp.com/"><button className='btn blue darken-4 waves-effect white teal-text'>Demo Site</button></a>
          </p>
        </Col>
        ...
        <Col s={12} l={3} className='projDescription'>
          ...
          <a href="https://github.com/smugclimber/BoozeClues"><button className='btn blue darken-4 waves-effect white teal-text'>Github Repo</button></a>
          <br/><br/>
          <a href="https://protected-sierra-25147.herokuapp.com/"><button className='btn blue darken-4 waves-effect white teal-text'>Demo Site</button></a>
          </p>
        </Col>
        <Col s={12} l={9} className='projImg'>
      ...
      <div className='Row workGlass'>
        <Col s={12} l={3} className='projDescription'>
          ...
          <p className='white-text'>BoredBuddy embraces boardgames and puzzles challenges. The project demonstrates skills in interacting with APIs from multiple sources(Amazon, Boardgamegeek, and YouTube). Users conduct boardgame database queries of a boardgame database, with the core functionality alleviating boardgame indecisiveness and providing help with a preferential and 'name-based' search engine. Additionally, if the user has a library of boardgames, they can interact with that data.<br/><br/>Tech used:<br/>Node Express, Materialize, JQuery, and Javascript<br/>
      		<a href="https://github.com/smugclimber/BoredBuddy"><button className='btn blue darken-4 waves-effect white teal-text'>Github Repo</button></a>
          <br/><br/>
          <a href="https://calm-earth-73897.herokuapp.com/"><button className='btn blue darken-4 waves-effect white teal-text'>Demo Site</button></a>
          </p>
        </Col>
        <Col s={12} l={9} className='projImg'>
      ...
      <div className='Row workGlass'>
        <Col s={12} l={3} className='projDescription'>
          ...
          <a href="https://github.com/smugclimber/BaggageClaim"><button className='btn blue darken-4 waves-effect white teal-text'>Github Repo</button></a>
          <br/><br/>
          <a href="https://smugclimber.github.io/BaggageClaim/"><button className='btn blue darken-4 waves-effect white teal-text'>Demo Site</button></a>
          </p>
        </Col>
        <Col s={12} l={9} className='projImg'>
      ...
      <div className='Row workGlass'>
        <Col s={12} l={3} className='projDescription'>
          ...
          <a href="https://github.com/smugclimber/time-bender"><button className='btn blue darken-4 waves-effect white teal-text'>Github Repo</button></a>
          <br/><br/>
          <a href="https://time-bender.herokuapp.com/"><button className='btn blue darken-4 waves-effect white teal-text'>Demo Site</button></a>
          </p>
        </Col>
        <Col s={12} l={9} className='projImg'>
